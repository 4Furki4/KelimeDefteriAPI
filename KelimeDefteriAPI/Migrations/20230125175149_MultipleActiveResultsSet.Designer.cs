...
namespace KelimeDefteriAPI.Migrations
{
    ...
    [Migration("20230125175149_MultipleActiveResultsSet")]
    partial class MultipleActiveResultsSet
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KelimeDefteriAPI.Context.EntityConcretes.Record", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1L,
                            Created = new DateTime(2023, 1, 25, 20, 51, 49, 556, DateTimeKind.Local).AddTicks(7215)
                        });
                });
